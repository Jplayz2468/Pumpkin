...
impl CaveSpiderEntity {
    pub fn new(entity: Entity) -> Arc<Self> {
...

        {
            ...
            // CaveSpider.java does not override `registerGoals`, so it inherits
            // `Spider.registerGoals()` (Spider.java:57-68) unchanged.
            ...
            // Spider.java:62: `WaterAvoidingRandomStrollGoal`, not the plain variant.
