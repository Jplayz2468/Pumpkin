...
pub fn main() {
    ...
    let mut build_functions: Vec<(BuilderFn, &str)> = vec![
        ...
        (loot_table::build_patch_fixtures, "../../../pumpkin/src/world/loot_patch_test_tables.rs"),
        (loot_table::build_name_instrument_fixtures, "../../../pumpkin/src/world/loot_name_instrument_test_tables.rs"),
        (loot_table::build_enchantment_fixtures, "../../../pumpkin/src/world/loot_enchantment_test_tables.rs"),
        (loot_table::build_transform_fixtures, "../../../pumpkin/src/world/loot_transform_test_tables.rs"),
